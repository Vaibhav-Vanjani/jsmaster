...
export const list:QuestionList[] = [
  {
    "id": "1",
  ...
  },
  {
    "id": "72",
    "question": "What's the output?",
    "snippet": "console.log(String.rawHello\\nworld);\n",
    "options": {
      "A": "Hello world!",
      "B": "Hello <br />&nbsp; &nbsp; &nbsp;world",
      "C": "Hello\\nworld",
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "The value of res in the second .then is equal to the returned value of the previous .then. You can keep chaining .thens like this, where the value is passed to the next handler.\n",
    "topic": "promises",
    "difficulty": "hard"
  },
  {
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "typeof name returns \"string\". The string \"string\" is a truthy value, so !typeof name returns the boolean value false. false === \"object\" and false === \"string\" both returnfalse.\n(If we wanted to check whether the type was (un)equal to a certain type, we should've written !== instead of !typeof)\n",
    "topic": "equality",
    "difficulty": "easy"
  },
  {
  ...
  },
  {
    "id": "146",
    "question": "What's the output?",
    "snippet": "function getFruit(fruits) {\n\tconsole.log(fruits?.[1]?.[1])\n}\n\ngetFruit([['🍊', '🍌'], ['🍍']])\ngetFruit()\ngetFruit([['🍍'], ['🍊', '🍌']])\n",
    "options": {
      "A": "null, undefined, 🍌",
      "B": "[], null, 🍌",
      "C": "[], [], 🍌",
  ...
  },
  {
    "id": "154",
    "question": "What's the output?",
    "snippet": "const createMember = ({ email, address = {}}) => {\n\tconst validEmail = /.+\\@.+\\..+/.test(email)\n\tif (!validEmail) throw new Error(\"Valid email pls\")\n\n\treturn {\n\t\temail,\n\t\taddress: address ? address : null\n\t}\n}\n\nconst member = createMember({ email: \"my@email.com\" })\nconsole.log(member)\n",
    "options": {
  ...
  },
  {
    "id": "155",
    "question": "What's the output?",
    "snippet": "let randomValue = { name: \"Lydia\" }\nrandomValue = 23\n\nif (!typeof randomValue === \"string\") {\n\tconsole.log(\"It's not a string!\")\n} else {\n\tconsole.log(\"Yay it's a string!\")\n}\n",
    "options": {
      "A": "It's not a string!",
      "B": "Yay it's a string!",
      "C": "TypeError",
